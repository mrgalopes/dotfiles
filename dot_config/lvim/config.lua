...
-- Moves text up and down (taken from chris@machine keymaps video)
vim.keymap.set("v", "<A-j>", ":m .+1<CR>==", { noremap = true, silent = true })
vim.keymap.set("v", "<A-k>", ":m .-1<CR>==", { noremap = true, silent = true })
...
lvim.builtin.which_key.mappings["j"] = { "<cmd>BufferLinePick<CR>", "Jump buffer" }
lvim.builtin.which_key.mappings["w"] = {
  name = "+Window",
  w = { "<C-w><C-w>", "Change window" }
}
...
lvim.plugins = {
  ...
  --     -- require("vim-tada")
  --     -- vim.g.tada_no_map = 1
  --     -- vim.g.tada_todo_switch_status_mapping = "<enter>"
  --   end
  -- },
  -- {
  --   "phaazon/hop.nvim",
